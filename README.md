...
2. **تشخیص محل پلاک**: برای هر خودرو، محل پلاک با استفاده از پردازش تصویر و تشخیص رنگ یافت می‌شود
...
اولین بار که برنامه را اجرا می‌کنید، مدل YOLOv8 به صورت خودکار دانلود می‌شود. اگر می‌خواهید از قبل آن را دانلود کنید:
